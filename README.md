...
- `software-design.html`: Enhancement One narrative and source/verification links
- `algorithms.html`: Enhancement Two narrative, performance comparison, and source/verification links
- `databases.html`: Enhancement Three narrative and source/verification links
- `documents/`: final Word self-assessment, three milestone narratives, and code-review script
